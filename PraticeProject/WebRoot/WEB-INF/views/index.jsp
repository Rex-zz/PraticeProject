				...
				<div class="navdiv">
					<div class="navul">
						<ul id="sddm" style="float: right;">
							...
							<li>
								<a onmouseover="mopen('m1045')" onmouseout="mclosetime()" href="zyxz.htm">注销</a>
				...
				<div class="submainleft">
					<div class="smleftnav">
						...
						<div class="smleftnavtop">
							<!--#begineditable name="栏目名称-左侧一级" action="" layout="" tpltype="" contype="" clone="" viewid="136231" contentviewid="" tagname="栏目名称-左侧一级"-->学生学业发展指导中心
							<!--#endeditable-->
						</div>
