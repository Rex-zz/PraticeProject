			...
			<div class="submainin png">
				...
				<div class="submainright">
					<div class="place">
						...
						<div class="placeleft">
							<!--#begineditable name="栏目名称-右侧" action="" layout="" tpltype="" contype="" clone="" viewid="136232" contentviewid="" tagname="栏目名称-右侧"-->实习意向调查表
							<!--#endeditable-->
						</div>
					</div>
					...
					<div class="sbmaincontent" style="float: right;">
						<div class="newslist">
							...
							<br />
							<div align="center">
								<form action="intention.action" method="post">
									...
									性别：<input type="radio" name="sex" <s:if test='#session.user.sex=="男"'>checked="checked"</s:if> value="男" />男
										<input type="radio" name="sex" <s:if test='#session.user.sex=="女"'>checked="checked"</s:if> value="女"/>女<br />
									实习方式：<label><input type="radio" name="way" <s:if test='#session.way==0'>checked="checked"</s:if> value="0"/>自主实习</label>
										<label><input type="radio" name="way" <s:if test='#session.way==1'>checked="checked"</s:if> value="1"/>需求安排<br/></label>
